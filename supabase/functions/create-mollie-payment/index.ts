  ...
  try {
    ...
    const { data: membership, error: membershipError } = await supabaseService
      ...
      .insert({
        ...
        motivation: membershipData.motivation || null,
        respectful_practices: membershipData.respectfulPractices || null,
        respectful_workplace: membershipData.respectfulWorkplace || null,
        boundary_behavior: membershipData.boundaryBehavior || null,
