-- Fix the handle_user_confirmation function to remove references to non-existent columns
...
BEGIN
  ...
  IF OLD.email_confirmed_at IS NULL AND NEW.email_confirmed_at IS NOT NULL THEN
    ...
    -- Only select from partner_memberships table since profiles doesn't have first_name/last_name
    SELECT pm.*
    INTO partner_record
