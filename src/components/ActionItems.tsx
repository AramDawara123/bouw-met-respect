    ...
    <section id="actie" className="py-24 bg-gradient-to-br from-background via-muted/20 to-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
                ...
                <div className="flex-1">
                  ...
                  <ul className="space-y-3">
                    {value.features.map((feature, idx) => (
                      <li key={idx} className="flex items-center text-sm text-accent group-hover:text-accent transition-colors duration-300">
        ...
        <div className="text-center mt-20">
          <Button 
            size="lg" 
            className="px-8 py-4 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-primary text-accent"
            onClick={() => setFormOpen(true)}
          >
