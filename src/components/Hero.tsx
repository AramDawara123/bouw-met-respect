    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 pb-16 lg:mt-16">
        ...
        <div 
          ...
          style={{ backgroundImage: 'url(/lovable-uploads/construction-workers.png)' }}
        >
        ...
        <div className="container mx-auto px-4">
          <div ref={featuresRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 md:mb-6 bg-primary/10 rounded-2xl flex items-center justify-center transition-transform duration-300">
