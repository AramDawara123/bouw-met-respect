        ...
        {profiles.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {profiles.map((profile) => (
              <Card key={profile.id} className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
                {profile.is_featured && (
                  <div className="bg-yellow-500 text-white text-xs font-bold px-3 py-1 rounded-br-lg absolute top-0 left-0">
                    Uitgelicht
                  </div>
                )}
